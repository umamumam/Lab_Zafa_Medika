@extends('layouts1.form') {{-- Sesuaikan dengan layout form Anda --}}
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-box me-2"></i>Form Tambah Paket Pemeriksaan</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pakets.store') }}" method="POST" id="paketForm">
                        @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                id="harga_umum" name="harga_umum" value="{{ old('harga_umum', 0) }}"
                                                min="0" required>
                                            @error('harga_umum')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                id="harga_bpjs" name="harga_bpjs" value="{{ old('harga_bpjs', 0) }}"
                                                min="0" required>
                                            @error('harga_bpjs')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
