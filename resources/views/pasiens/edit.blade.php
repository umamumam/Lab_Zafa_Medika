...
<div class="page-inner">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="text-muted">No RM: {{ $pasien->norm }}</div>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                   id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $pasien->tgl_lahir->format('Y-m-d')) }}" required>
                            @error('tgl_lahir')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status_pasien') is-invalid @enderror"
                                    id="status_pasien" name="status_pasien" required>
                                <option value="">Pilih Status Pasien</option>
                                @foreach(['APS / UMUM', 'Asuransi', 'BPJS', 'Lupis', 'Medical Check Up', 'Prolanis', 'Rujukan Faskes', 'Rujukan Dokter', 'Lainnya'] as $status)
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror"
                                   id="nik" name="nik" value="{{ old('nik', $pasien->nik) }}"
