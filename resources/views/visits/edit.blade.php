        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white py-3">
                    <h5 class="mb-0"><i class="fas fa-file-medical me-2"></i>Form Edit Permintaan Pemeriksaan</h5>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <span id="totalTagihan">Rp {{($visit->total_tagihan) }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
...
<script>
    $(document).ready(function() {
        ...
        // Auto-set patient data when selected
        ...
        // Auto-set doctor when room selected
        ...
        $('#addTest').click(function() {
            ...
            // Update the name attributes with proper indexing
        ...
        // Update prices when patient type changes
        ...
        // Initialize existing test items with event handlers
        $('#testItems tr').each(function() {
            const row = $(this);
            const jumlahInput = row.find('.test-jumlah');
            const hargaText = row.find('.test-harga').text();
            const harga = parseInt(hargaText.replace(/\D/g, ''));

            jumlahInput.change(function() {
                const newJumlah = $(this).val() || 1;
                const newSubtotal = harga * newJumlah;
                row.find('.test-subtotal').text(formatRupiah(newSubtotal));
                updateTotal();
            });

            row.find('.remove-test').click(function() {
                row.remove();
                updateTotal();
            });
        });
